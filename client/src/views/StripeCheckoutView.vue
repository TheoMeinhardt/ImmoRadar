<template>
  <div class="bg-gray-50">
    <div>
      <p class="text-h3 block">Mehr Möglichekiten mit Immoradar Premium!</p>
      <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
        ...
        <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
          <div class="inline-flex rounded-md shadow">
            ...
            <a @click="createCheckout" href="#" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-5 py-3 text-base font-medium text-white hover:bg-indigo-700">Premium 5€</a>
          </div>
        </div>
      </div>
    </div>

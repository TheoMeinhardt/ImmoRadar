<template>
	<div @submit.prevent="submitRegister" class="q-mx-md">
		...
		<div style="text-align: center">
			<q-btn type="submit" rounded color="light-blue-3" style="font-family: Keep Calm; width: 300px" align="center" label="Register" class="btn" to="/" />
		</div>
	</div>
</template>
